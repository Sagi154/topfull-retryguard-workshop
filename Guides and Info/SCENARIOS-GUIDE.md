...
# 3. Pull results to your PC after the run completes (runner prints the exact command)
#    Campaign / new runs → campaign_48/<Sx_scenario_name>/; August historical folders → august_38/
